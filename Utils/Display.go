...
func Display() {
	...
	fmt.Printf("\n\n     - /produk      -> GET        |  - /keranjang      -> GET       |  - /transaksi      -> GET")
	fmt.Printf("\n     - /produk      -> POST       |  - /keranjang      -> POST      |  - /transaksi      -> POST")
	fmt.Printf("\n     - /produk/{id} -> GET        |  - /keranjang/{id} -> GET       |  - /transaksi/{id} -> GET")
	fmt.Printf("\n     - /produk/{id} -> PUT        |  - /keranjang/{id} -> PUT       |  - /transaksi/{id} -> PUT")
	...
	fmt.Printf("\n\n     - /keranjang      -> GET     |  - /transaksi      -> GET       |  - /detail-transaksi      -> GET")
	fmt.Printf("\n     - /keranjang      -> POST    |  - /transaksi      -> POST      |  - /detail-transaksi      -> POST")
	fmt.Printf("\n     - /keranjang/{id} -> GET     |  - /transaksi/{id} -> GET       |  - /detail-transaksi/{id} -> GET")
	fmt.Printf("\n     - /keranjang/{id} -> PUT     |  - /transaksi/{id} -> PUT       |  - /detail-transaksi/{id} -> PUT")
